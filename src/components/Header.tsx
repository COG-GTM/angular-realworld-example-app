...
const navLinkClass = ({ isActive }: { isActive: boolean }) => cx('nav-link', { active: isActive });

/**
 * Top navigation bar. Renders different links per auth state. The navbar is
 * always present (even while 'loading'/'unavailable') so the app never blanks.
 */
      ...
      <div className="container">
        ...
        {authState === 'unauthenticated' && (
          <ul className="nav navbar-nav pull-xs-right">
            ...
            <li className="nav-item">
              <NavLink className={({ isActive }) => cx('nav-link', 'nav-signup', { active: isActive })} to="/register">
                Sign up
              </NavLink>
            </li>
          </ul>
